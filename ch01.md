...
The CloudKernelOS shared I/O software architecture is ***faster than a communication bus*** because the architecture structures compute of shared bare metal I/O of hundreds or thousands of nodes. It not a back-and-forth fast bus, but rather ***directly SHARED*** I/O across an interwoven neurofabric of multiple intelligent nodes, ie *the SPEED of the SoNS* depends upon SHARING, not shuttling back-and-forth.
