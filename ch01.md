...
FreeRTOS is a collection of C libraries comprised of a real-time kernel and a set of modular libraries that implement complementary functionality. CloudKernelOS is a collection of C and Rust libraries which supports shared data and coordination in [Self-Organizing Nervous Systems (SoNS)](https://arxiv.org/abs/2401.13103) for building swarm robotics and highly-distributed, independent, but self-organizing coordinated multi-drone swarm technologies.
